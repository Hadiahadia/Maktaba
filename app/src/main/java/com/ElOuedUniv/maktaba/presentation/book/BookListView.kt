    ...
    Scaffold(
                ...
                actions = {
                    IconButton(onClick = onCategoriesClick) {
                        Icon(
                            ...
                            tint = Color.White // نخلي أيقونة Menu بيضاء
                        )
                    }
                },
                colors = TopAppBarDefaults.topAppBarColors(
                    containerColor = Color(0xFFFFC0CB), // وردي بينك
                    titleContentColor = Color.White      // الكلمة باللون الأبيض
                )
            )
        },
        floatingActionButton = {
            FloatingActionButton(
                ...
                containerColor = Color(0xFFFFC0CB), // وردي بينك
                contentColor = Color.White           // علامة زائد بيضاء
            ) {
                Icon(
