...
class BookRepository {
    ...
    private val booksList = listOf(
        ...
        Book(isbn = "978-59-600712-6", title =  "Perl Cookbook", nbPages = 791),
        Book(isbn = "978-15-6592243-3", title = "How to Design Programes", nbPages = 791),
        Book(isbn = "978-05-9652684-9", title = "Head First SQL", nbPages = 500),
        Book(isbn = "978-14-9207652-0", title = "Head First Android Development", nbPages = 930),
        Book(isbn = "978-14-9195432-4", title = "Learning Perl", nbPages = 394),
        Book(isbn = "978-02-0170431-1", title = "Modren C++ Design", nbPages = 323)
    )
